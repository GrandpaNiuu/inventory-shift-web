...
import UniversalBusinessReportApp from "./UniversalBusinessReportApp";
...
const tabs: Array<[SuiteTab, string, string]> = [
  ["universal", "万能核对中心", "任意 Excel 自动识别并生成多业务核对面板"],
  ...
  return <main className="min-h-screen bg-slate-50">
    <div className="mx-auto max-w-7xl px-4 pt-4 md:px-8 md:pt-8">
      <header className="rounded-3xl bg-gradient-to-br from-slate-950 to-slate-800 p-6 text-white shadow-sm">
        ...
        <p className="mt-2 max-w-4xl text-sm leading-6 text-slate-300">支持任意 Excel 智能识别、自动业务核对面板、当前商品报表专用核对，以及更广范围的全球商品分类覆盖。系统会逐步通过模板和商品词库学习，提高后续自动化准确率。</p>
      </header>
    ...
    <div className="mt-6">
      {tab === "universal" ? <UniversalBusinessReportApp /> : null}
